...
type ChainConfig = { [chainId: number]: BasicChainInformation | ExtendedChainInformation } | any
...
export const MAINNET_CHAINS: ChainConfig = {
  ...
  43114: {
    urls: [getInfuraUrlFor('Avalanche-mainnet'), 'https://api.avax.network/ext/bc/C/rpc'].filter(Boolean),
    name: 'Avalanche',
    nativeCurrency: AVAX,
    blockExplorerUrls: ['https://snowtrace.io'],
  },
  56: {
    urls: [getInfuraUrlFor('BNB-mainnet'), 'https://bsc-dataseed.binance.org'].filter(Boolean),
    name: 'BNB',
    nativeCurrency: BNB,
